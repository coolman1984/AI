...
| E20 | 2026-07-02 | A1.2 documentation/routing cleanup approved by owner | owner approval + tests | User approved in Codex session; `03_design/assistant_master_plan.md`; `03_design/current_implementation_plan.md`; `AGENTS.md`; `AGENT_SKILL_MAP.md`; `00_control/restart_notes.md`; `00_control/task_queue.md`; prior `pytest` => 78 passed, 4 skipped | owner review + re-run | High |
