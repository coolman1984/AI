...
`brief_audit.audit_brief_claims`.
...
Document-derived brief claims also need an independent second extraction and citation re-check;
material disagreements route to human review and never auto-merge.
**Tests:** `pytest tests/test_card_and_audit.py`; `pytest tests/test_brief_audit.py`
